...
--We create the relation "Follows"
...
SELECT * FROM bd030_schema21.playlist_songs WHERE playlist_id='PL000011'
...
VALUES ('ALB99W9', 'Trigger Test Album', '2024-01-01', 'Studio', 0, 0);

INSERT INTO song (song_id, song_title, song_duration, song_release_date, play_count, is_single, album_id)
VALUES 
('S9991S', 'Test Song 1', 3.50, '2024-01-02', 0, FALSE, 'ALB99W9'),
('S9992S', 'Test Song 2', 4.20, '2024-01-03', 0, FALSE, 'ALB99W9');

SELECT album_id, album_name, album_duration
FROM album
WHERE album_id = 'ALB999';
...
INSERT INTO users (user_id, user_nick, first_name, surname, user_password, email, phone_number, date_birth, age, country)
VALUES ('U3001', 'premium_user', 'Alice', 'Lopez', 'pass123', 'alice@example.com', '123458789', '1995-01-01', 30, 'Spain');

INSERT INTO user_premium (user_id, premium_quiality, download_music, subscription_id)
VALUES ('U3001', 'High', TRUE, 'SUB3001');

INSERT INTO subscription_plan (subscription_id, user_id, subscription_name, duration_months, price, subscription_status, subscription_description, max_devices)
VALUES ('SUB3001', 'U3001', 'Gold Plan', 6, 59.99, 'Active', 'Premium plan', 3);

SELECT * FROM subscription_plan WHERE user_id = 'U3001';
DELETE FROM user_premium WHERE user_id = 'U3001';
SELECT * FROM subscription_plan WHERE user_id = 'U3001';
...
INSERT INTO song (song_id, song_title, song_duration, song_release_date, play_count, is_single, album_id)
VALUES ('S8001', 'Independent Song', 3.45, '2024-04-10', 0, FALSE, NULL);

SELECT song_id, song_title, is_single, album_id
FROM song
WHERE song_id = 'S8001';

INSERT INTO song (song_id, song_title, song_duration, song_release_date, play_count, is_single, album_id)
VALUES ('S8002', 'Album Song', 4.00, '2024-04-11', 0, FALSE, 'ALB001');
...
SELECT song_id, song_title, play_count
FROM song
WHERE song_id = 'SNG0013';


INSERT INTO play_history (
    playback_id, user_id, song_id, device_id, playlist_id, play_date, duration_played, completed
) VALUES (
    'PH2S0', 'user_1', 'SNG0013','D000011', 'PL000012', CURRENT_DATE, 3.50, TRUE
);
